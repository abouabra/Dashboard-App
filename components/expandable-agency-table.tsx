...
import { ChevronDown, MapPin, Users, Building2, Phone, Globe, Mail, MapIcon, BookOpen, TrendingUp, School, Shield, Map, Loader2 } from "lucide-react";
								...
								<TableRow onClick={() => toggleExpand(row.id)} className="cursor-pointer border-border transition-colors hover:bg-secondary">
									...
									<TableCell className="text-right">
										<div className="flex items-center justify-end gap-2">
											...
											<span className="text-foreground">{formatValue(row.population)}</span>
										</div>
									</TableCell>
								</TableRow>
										...
										<TableCell colSpan={4} className="p-6">
											<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
														...
														<DetailField
															...
															value={
																currentExpandedData.website ? (
																	<a href={currentExpandedData.website} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
																		{currentExpandedData.website}
																	</a>
																) : (
																	"N/A"
												...
												<div className="space-y-3">
													...
													<div className="space-y-3">
														<DetailField label="Mailing Address" value={currentExpandedData.mailing_address} icon={MapPin} />
														<DetailField label="Physical Address" value={currentExpandedData.physical_address} icon={MapIcon} />
													</div>
												</div>
												...
												<div className="space-y-3">
													...
													<div className="space-y-3">
														<DetailField label="Total Schools" value={formatValue(currentExpandedData.total_schools)} icon={School} />
														<DetailField label="Total Students" value={formatValue(currentExpandedData.total_students)} icon={Users} />
														<DetailField label="Student-Teacher Ratio" value={formatValue(currentExpandedData.student_teacher_ratio)} icon={TrendingUp} />
													</div>
												</div>
												...
												<div className="space-y-3">
													...
													<div className="space-y-3">
														...
														<DetailField label="Supervisory Union" value={currentExpandedData.supervisory_union} icon={Shield} />
												...
												<div className="space-y-3">
													...
													<div className="space-y-3">
														...
														<DetailField label="Last Updated" value={formatDate(currentExpandedData.updated_at)} icon={Map} />
													</div>
												</div>
											</div>
										</TableCell>
